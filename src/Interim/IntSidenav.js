...
const Sidebar = styled.div`
  width: ${({ isSidebarOpen }) => (isSidebarOpen ? "250px" : "70px")};
      ...
      <SidebarMenu>
        ...
        {isDropdownOpen.userManagement && (
          <ul style={{ paddingLeft: "20px", listStyleType: "none" }}>
            ...
            <Link to="/addappraisers" style={{ textDecoration: "none" }}>
              <li>
                <SidebarItem isSidebarOpen={isSidebarOpen}>
                  <FontAwesomeIcon icon={faUserEdit} className="icon" />
        ...
        <SidebarItem isSidebarOpen={isSidebarOpen} onClick={() => handleDropdownToggle("manageSection")}>
      ...
      {isLogoutModalOpen && (
        <ModalBackdrop>
          <ModalContent>
            ...
            <ModalButton onClick={cancelLogout} style={{ backgroundColor: "#6c757d", marginLeft: "10px" }}>
              Cancel
            </ModalButton>
          </ModalContent>
        </ModalBackdrop>
