...
const StyledCard = styled(Card)`
  ...
  border-left: 6px solid
    ${({ status }) => (status === "Available" ? "#4caf50" : "#f44336")};
  justify-content: space-between;
`;
