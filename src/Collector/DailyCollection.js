...
import { FaBars, FaSearch, FaUserCircle, FaSignOutAlt, FaExclamationCircle } from "react-icons/fa";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faHome, faShoppingCart, faSearch, faEye, faCheckCircle, faBell } from "@fortawesome/free-solid-svg-icons";
...
const Dashboard = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      setStallHolders(filteredData);
    } catch (error) {
      console.error("Error searching stallholders:", error);
    }
  };
          ...
          <StallHolderContainer>
            {stallHolders.map((stall) => (
              <StallHolderCard key={stall.id}>
                ...
                <DueDate>
                  Due Date: {stall.dueDate && stall.dueDate instanceof Date
                    ? stall.dueDate.toLocaleDateString()
                    : "N/A"}
                </DueDate>
                <StallHolderInfo>
                  <div>
